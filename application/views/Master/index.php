                            ...
                            <div class="page-title-box">
                                <h4>Dashboard</h4>
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Reshimbandhan</a></li>
                                    ...
                                    <div class="inbox-wid">
                                        <a href="#" class="text-dark">
                                            <div class="inbox-item">
                                                <div class="inbox-item-img float-left mr-3"><img src="<?php echo base_url(); ?>assets/images/users/user-1.jpg" class="avatar-sm rounded-circle" alt=""></div>
                                        ...
                                        <a href="#" class="text-dark">
                                            <div class="inbox-item">
                                                <div class="inbox-item-img float-left mr-3"><img src="<?php echo base_url(); ?>assets/images/users/user-2.jpg" class="avatar-sm rounded-circle" alt=""></div>
                                        ...
                                        <a href="#" class="text-dark">
                                            <div class="inbox-item">
                                                <div class="inbox-item-img float-left mr-3"><img src="<?php echo base_url(); ?>assets/images/users/user-3.jpg" class="avatar-sm rounded-circle" alt=""></div>
                                        ...
                                        <a href="#" class="text-dark">
                                            <div class="inbox-item">
                                                <div class="inbox-item-img float-left mr-3"><img src="<?php echo base_url(); ?>assets/images/users/user-4.jpg" class="avatar-sm rounded-circle" alt=""></div>
                                        ...
                                        <a href="#" class="text-dark">
                                            <div class="inbox-item">
                                                <div class="inbox-item-img float-left mr-3"><img src="<?php echo base_url(); ?>assets/images/users/user-5.jpg" class="avatar-sm rounded-circle" alt=""></div>
                                        ...
                                        <a href="#" class="text-dark">
                                            <div class="inbox-item">
                                                <div class="inbox-item-img float-left mr-3"><img src="<?php echo base_url(); ?>assets/images/users/user-6.jpg" class="avatar-sm rounded-circle" alt=""></div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-centered table-vertical table-nowrap">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <img src="<?php echo base_url(); ?>assets/images/users/user-2.jpg" alt="user-image" class="avatar-xs rounded-circle mr-2" /> Herbert C. Patton
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="<?php echo base_url(); ?>assets/images/users/user-3.jpg" alt="user-image" class="avatar-xs rounded-circle mr-2" /> Mathias N. Klausen
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="<?php echo base_url(); ?>assets/images/users/user-4.jpg" alt="user-image" class="avatar-xs rounded-circle mr-2" /> Nikolaj S. Henriksen
                                                    </td>
                                                    <td><i class="mdi mdi-checkbox-blank-circle text-success"></i> Confirm</td>
                                                    <td>
                                                        $954
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="<?php echo base_url(); ?>assets/images/users/user-5.jpg" alt="user-image" class="avatar-xs rounded-circle mr-2" /> Lasse C. Overgaard
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="<?php echo base_url(); ?>assets/images/users/user-6.jpg" alt="user-image" class="avatar-xs rounded-circle mr-2" /> Kasper S. Jessen
                                                    </td>
                                                    <td><i class="mdi mdi-checkbox-blank-circle text-success"></i> Confirm</td>
                                                    <td>
                                                        $8,844
                                        ...
                                        <table class="table table-centered table-vertical table-nowrap mb-1">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>#12354781</td>
                                                    <td>
                                                        <img src="<?php echo base_url(); ?>assets/images/users/user-1.jpg" alt="user-image" class="avatar-xs mr-2 rounded-circle" /> Riverston Glass Chair
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>#52140300</td>
                                                    <td>
                                                        <img src="<?php echo base_url(); ?>assets/images/users/user-2.jpg" alt="user-image" class="avatar-xs mr-2 rounded-circle" /> Shine Company Catalina
                                                    </td>
                                                    <td><span class="badge badge-pill badge-success">Delivered</span></td>
                                                    <td>
                                                        $1,024
                                                ...
                                                <tr>
                                                    <td>#96254137</td>
                                                    <td>
                                                        <img src="<?php echo base_url(); ?>assets/images/users/user-3.jpg" alt="user-image" class="avatar-xs mr-2 rounded-circle" /> Trex Outdoor Furniture Cape
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>#12365474</td>
                                                    <td>
                                                        <img src="<?php echo base_url(); ?>assets/images/users/user-4.jpg" alt="user-image" class="avatar-xs mr-2 rounded-circle" /> Oasis Bathroom Teak Corner
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>#85214796</td>
                                                    <td>
                                                        <img src="<?php echo base_url(); ?>assets/images/users/user-5.jpg" alt="user-image" class="avatar-xs mr-2 rounded-circle" /> BeoPlay Speaker
                                                    </td>
                                                    <td><span class="badge badge-pill badge-success">Delivered</span></td>
                                                    <td>
                                                        $584
                                                ...
                                                <tr>
                                                    <td>#12354781</td>
                                                    <td>
                                                        <img src="<?php echo base_url(); ?>assets/images/users/user-6.jpg" alt="user-image" class="avatar-xs mr-2 rounded-circle" /> Riverston Glass Chair
                                                    </td>
                                                    <td><span class="badge badge-pill badge-success">Delivered</span></td>
                                                    <td>
                                                        $185
